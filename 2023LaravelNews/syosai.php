...
<body>
    <header id="header">
        <a href="http://localhost:8888/2023LaravelNews/index.php" target="_new" rel="noopener"  class="pagetop">Laravel News</a><!--_newは1回目別タブ、2回目は1ページ目を読み込む-->
    </header>
...
<a href="http://localhost:8888/2023LaravelNews/index.php">トップへ戻る</a>
</body>
</html>